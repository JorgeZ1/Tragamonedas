...
const Map<String, GameSymbol> kSymbols = {
  ...
  'mini_apple':   GameSymbol(type: 'mini_apple',   baseType: 'apple',      display: '🍎', prize: 1, message: 'MINI MANZANA',    isMini: true),
  'orange':       GameSymbol(type: 'orange',       display: '🍊', prize: 30,  message: 'NARANJAS'),
  ...
  'plum':         GameSymbol(type: 'plum',         display: '🍇', prize: 20,  message: 'CIRUELAS'),
  'mini_plum':    GameSymbol(type: 'mini_plum',    baseType: 'plum',       display: '🍇', prize: 2, message: 'MINI CIRUELA',    isMini: true),
  'watermelon':   GameSymbol(type: 'watermelon',   display: '🍉', prize: 30,  message: 'SANDÍAS'),
  'mini_watermelon': GameSymbol(type: 'mini_watermelon', baseType: 'watermelon', display: '🍉', prize: 2, message: 'MINI SANDÍA', isMini: true),
  'bell':         GameSymbol(type: 'bell',         display: '🔔', prize: 15,  message: 'CAMPANAS'),
  'mini_bell':    GameSymbol(type: 'mini_bell',    baseType: 'bell',       display: '🔔', prize: 1, message: 'MINI CAMPANA',    isMini: true),
  'star':         GameSymbol(type: 'star',         display: '🌟', prize: 35,  message: '¡ESTRELLA!'),
  ...
  'bar':          GameSymbol(type: 'bar',          display: 'BAR', prize: 50,  message: '¡BAR ROJO!'),
  'mini_bar':     GameSymbol(type: 'mini_bar',     baseType: 'bar',        display: 'BAR', prize: 5, message: 'MINI BAR',       isMini: true),
  'bar1000':      GameSymbol(type: 'bar1000',      baseType: 'bar',        display: 'BAR', prize: 100, message: '¡BAR 1000!'),
